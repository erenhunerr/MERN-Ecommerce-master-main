...
const Product = () => {
    ...
    return(
        ...
        <h2 class="text-2xl font-medium text-gray-800 uppercase mb-6">Sizin için önerilen</h2>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div class="bg-white shadow rounded overflow-hidden group">
                ...
                <a href="#"
                    class="block w-full py-1 text-center text-white bg-primary border border-primary rounded-b hover:bg-transparent hover:text-primary transition">Sepete Ekle</a>
            </div>
            <div class="bg-white shadow rounded overflow-hidden group">
                <div class="relative">
