              ...
              <div class="flex items-center ms-3">
                <div>
                  ...
                  <Link to="/" class="text-center text-gray-700 hover:text-primary transition relative">
                    ...
                    <div class="text-xs leading-3">Mağazaya Git</div>
                  </Link>
                </div>
                <div
          ...
          <ul class="space-y-2 font-medium">
            <li>
              <Link class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                ...
                <span class="ms-3">Ana Sayfa</span>
              </Link>
            ...
            <li>
              <Link class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Kullanıcılar</span>
              </Link>
            </li>
            <li>
              <Link class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                ...
                <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                  aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="21" height="20" fill="none" viewBox="0 0 20 18">
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Ürün Ekle</span>
              </Link>
            </li>
            ...
            <li>
              <Link class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                ...
                <span class="flex-1 ms-3 whitespace-nowrap">Ürünler</span>
              </Link>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span onClick={handleLogout} class="flex-1 ms-3 whitespace-nowrap">Çıkış Yap</span>
              </a>
            </li>
          </ul>
        </div>
